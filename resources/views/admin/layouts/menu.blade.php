    ...
    <ul class="menu-inner py-1">
        <li class="menu-item active">
            <a href="{{ route('admin.dashboard.index') }}"
                class="menu-link">
                <i class="badge-dot-icon menu-icon mdi mdi-home"></i>
                <div>Dashboard</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="#"
                class="menu-link">
                <i class="badge-dot-icon menu-icon mdi mdi-view-module"></i>
                <div>Categories</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="#"
                class="menu-link">
                <i class="badge-dot-icon menu-icon mdi mdi-package"></i>
                <div>Product</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="#"
                class="menu-link">
                <i class="badge-dot-icon menu-icon mdi mdi-calculator"></i>
                <div>Kasir</div>
            </a>
        </li>
        <li class="menu-item">
            <a href="#"
                class="menu-link">
                <i class="badge-dot-icon menu-icon mdi mdi-history"></i>
                <div>Transaction</div>
            </a>
        </li>
    </ul>
